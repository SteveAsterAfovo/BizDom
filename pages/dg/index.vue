  ...
  <div class="p-6 max-w-7xl mx-auto space-y-8 animate-fade-in">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2 space-y-6">
        <!-- Strike Risk Meter -->
        <h3 class="text-white font-black italic uppercase tracking-tight">Climat Social</h3>
        <div class="grid grid-cols-2 gap-4 mb-6">
          <div class="p-4 rounded-2xl bg-dark-850 border border-white/5">
            ...
            <p class="text-xl font-black" :class="companyStore.productivity > 0.8 ? 'text-gain-400' : 'text-loss-500'">
              {{ companyStore.productivity > 0.8 ? 'EXCELLENT' : companyStore.productivity > 0.5 ? 'STABLE' : 'CRITIQUE'
              }}
            </p>
          </div>
          <div class="p-4 rounded-2xl bg-dark-850 border border-white/5">
            <p class="text-[9px] text-dark-500 font-black uppercase">Réclamations Active</p>
        ...
        <div class="flex justify-between items-end mb-4">
          <div>
            <p class="text-[10px] text-dark-500 uppercase font-black">Indicateur de Grève</p>
          </div>
